...
Module DBOperation
    ...
    Private BasicSchemaChecked As Boolean
    ...
    Public Sub EnsureBasicSchema()

        If BasicSchemaChecked Then Exit Sub
        If MdbConnect Is Nothing Then Exit Sub

        Try
            MdbConnect.Execute("ALTER TABLE Table_Basic ADD COLUMN AtlasTool1Ip TEXT(255)")
        Catch ex As Exception
        End Try

        Try
            MdbConnect.Execute("ALTER TABLE Table_Basic ADD COLUMN AtlasTool2Ip TEXT(255)")
        Catch ex As Exception
        End Try

        BasicSchemaChecked = True
    ...
    Sub ConnectionOpenSQL()
        ...
        Try
            ...
            connection_string = "Provider=SQLOLEDB;Data Source=192.168.0.222\Ftech_Svr;Initial Catalog=FTECH_SVR;User ID=sa;Password=sns123.,"
