Module Module1
    ...
    Public Sub LoadBasicData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            Try
                AtlasTool1Ip = CStr(Rs.Fields("AtlasTool1Ip").Value)
                If Trim(AtlasTool1Ip) = "" Then AtlasTool1Ip = "192.168.250.12"
            Catch ex As Exception
                AtlasTool1Ip = "192.168.250.12"
            End Try
            Try
                AtlasTool2Ip = CStr(Rs.Fields("AtlasTool2Ip").Value)
                If Trim(AtlasTool2Ip) = "" Then AtlasTool2Ip = "192.168.250.13"
            Catch ex As Exception
                AtlasTool2Ip = "192.168.250.13"
            End Try
    ...
    Public Sub SaveBasicData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            Rs.Fields("AtlasTool1Ip").Value = CStr(AtlasTool1Ip)
            Rs.Fields("AtlasTool2Ip").Value = CStr(AtlasTool2Ip)
