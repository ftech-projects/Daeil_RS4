Module Module1
    ...
    Public Sub SaveBasicData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            Rs.Fields("FrtMin_STDLH").Value = CStr(BAsicFrtMin_STDLH)
            Rs.Fields("FrtMax_STDLH").Value = CStr(BAsicFrtMax_STDLH)

            Rs.Fields("RearMin_STDLH").Value = CStr(BAsicRearMin_STDLH)
            Rs.Fields("RearMax_STDLH").Value = CStr(BAsicRearMax_STDLH)

            Rs.Fields("FrtMin_VIPRH").Value = CStr(BAsicFrtMin_VIPRH)
            Rs.Fields("FrtMax_VIPRH").Value = CStr(BAsicFrtMax_VIPRH)
            Rs.Fields("RearMin_VIPRH").Value = CStr(BAsicRearMin_VIPRH)
            Rs.Fields("RearMax_VIPRH").Value = CStr(BAsicRearMax_VIPRH)

            Rs.Fields("FrtMin_FOLDRH").Value = CStr(BAsicFrtMin_FOLDRH)
            Rs.Fields("FrtMax_FOLDRH").Value = CStr(BAsicFrtMax_FOLDRH)
            Rs.Fields("RearMin_FOLDRH").Value = CStr(BAsicRearMin_FOLDRH)
            Rs.Fields("RearMax_FOLDRH").Value = CStr(BAsicRearMax_FOLDRH)

            Rs.Fields("RearTolVIP").Value = CStr(BasicRearTolVIP)
            Rs.Fields("FrtTolVIP").Value = CStr(basicFrtTolVIP)

            Rs.Fields("RearTolstd").Value = CStr(BasicRearTolSTD)
            Rs.Fields("FrtTolstd").Value = CStr(basicFrtTolSTD)

            Rs.Fields("RearTolfold").Value = CStr(BasicRearTolFOLD)
            Rs.Fields("FrtTolfold").Value = CStr(basicFrtTolFOLD)
    ...
    Public Sub LoadPortData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            PortNumber_Scanner = Rs.Fields("Scanner").Value
            PortNumber_Printer = Rs.Fields("Printer").Value
            PortNumber_Tool = Rs.Fields("Tool").Value
