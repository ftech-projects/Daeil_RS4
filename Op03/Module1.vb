Module Module1
    ...
    Public PortNumber_Tool1 As String
    Public PortNumber_Tool2 As String
    Public PortNumber_Tool3 As String
    Public PortNumber_Resist1 As String
    Public PortNumber_Resist2 As String
    ...
    Public BAsicMotorUnit As String
    Public BasicMotorToolMax As Double
    Public BasicMotorToolMin As Double
    
    Public BAsicSabUnit As String
    Public BasicSabToolMax As Double
    Public BasicSabToolMin As Double

    Public BasicResistMax As Double
    Public BasicResistMin As Double
    ...
    Public Sub LoadBasicData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            BAsicMotorUnit = CStr(Rs.Fields("MotorUnit").Value)
            BasicMotorToolMin = CDbl(Rs.Fields("toolMotormin").Value)
            BasicMotorToolMax = CDbl(Rs.Fields("toolMotormax").Value)

            BAsicSabUnit = CStr(Rs.Fields("SabUnit").Value)
            BasicSabToolMin = CDbl(Rs.Fields("toolSabmin").Value)
            BasicSabToolMax = CDbl(Rs.Fields("toolSabmax").Value)

            BasicResistMin = CDbl(Rs.Fields("Resistmin").Value)
            BasicResistMax = CDbl(Rs.Fields("Resistmax").Value)
    ...
    Public Sub SaveBasicData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            Rs.Fields("MotorUnit").Value = BAsicMotorUnit
            Rs.Fields("toolMotormin").Value = CStr(BasicMotorToolMin)
            Rs.Fields("toolMotormax").Value = CStr(BasicMotorToolMax)

            Rs.Fields("SabUnit").Value = BAsicSabUnit
            Rs.Fields("toolSabmin").Value = CStr(BasicSabToolMin)
            Rs.Fields("toolSabmax").Value = CStr(BasicSabToolMax)

            Rs.Fields("Resistmin").Value = CStr(BasicResistMin)
            Rs.Fields("Resistmax").Value = CStr(BasicResistMax)
    ...
    Public Sub LoadPortData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            PortNumber_Tool1 = Rs.Fields("tool1").Value
            PortNumber_Tool2 = Rs.Fields("tool2").Value
            PortNumber_Tool3 = Rs.Fields("tool3").Value
            PortNumber_Resist1 = Rs.Fields("Resist1").Value
            PortNumber_Resist2 = Rs.Fields("Resist2").Value
        End If
    ...
    Public Sub SavePortData()
        ...
        If Rs.RecordCount = 1 Then
            ...
            Rs.Fields("Tool1").Value = PortNumber_Tool1
            Rs.Fields("Tool2").Value = PortNumber_Tool2
            Rs.Fields("Tool3").Value = PortNumber_Tool3

            Rs.Fields("Resist1").Value = PortNumber_Resist1
            Rs.Fields("Resist2").Value = PortNumber_Resist2
