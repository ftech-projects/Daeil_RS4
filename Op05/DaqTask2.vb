...
Imports System.Threading
    ...
    <TemplateData("StartReadWfmLoopStop", MxbFile:="DaqTask2.mxb")> _
    Partial Class DaqTask2Component
        ...
        Protected Overrides Function CreateTask() As Task
            Dim newTask As DaqTask2 = New DaqTask2()
        ...
        Protected Overrides Sub EndReadContinuous(ByVal result As IAsyncResult)
            Try
                ...
                Dim args As DaqTask2ComponentDataReadyEventArgs = New DaqTask2ComponentDataReadyEventArgs(data)
                OnDataReady(args)
        ...
        ''' </param>
        Protected Overridable Sub OnDataReady(ByVal e As DaqTask2ComponentDataReadyEventArgs)
        ...
        Public Custom Event DataReady As EventHandler(Of DaqTask2ComponentDataReadyEventArgs)
            AddHandler(ByVal value As EventHandler(Of DaqTask2ComponentDataReadyEventArgs))
                AddEventHandler(EventDataReady, value)
            End AddHandler

            RemoveHandler(ByVal value As EventHandler(Of DaqTask2ComponentDataReadyEventArgs))
                RemoveEventHandler(EventDataReady, value)
            End RemoveHandler

            RaiseEvent(ByVal sender As Object, ByVal e As DaqTask2ComponentDataReadyEventArgs)
    ...
    ''' </summary>
    Public Class DaqTask2ComponentDataReadyEventArgs
    ...
    Partial Class DaqTask2Component
        ...
        Public Custom Event ReadCompleted As EventHandler(Of DaqTask2ComponentReadCompletedEventArgs)
            AddHandler(ByVal value As EventHandler(Of DaqTask2ComponentReadCompletedEventArgs))
            ...
            RemoveHandler(ByVal value As EventHandler(Of DaqTask2ComponentReadCompletedEventArgs))
                Throw New NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.")
            End RemoveHandler

            RaiseEvent(ByVal sender As Object, ByVal e As DaqTask2ComponentReadCompletedEventArgs)
                Throw New NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.")
            End RaiseEvent
        End Event
    End Class
    ...
    ''' </summary>
    <EditorBrowsable(EditorBrowsableState.Never)> _
    Public Class DaqTask2ComponentReadCompletedEventArgs
    ...
    Public Class DaqTask2
        ...
        Public Overridable Sub Configure()
            ...
            ' is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev3/ai0", "Laser1", AITerminalConfiguration.Rse, 0, 5, AIVoltageUnits.Volts)
                AIChannels.CreateVoltageChannel("Dev3/ai1", "Laser2", AITerminalConfiguration.Rse, 0, 5, AIVoltageUnits.Volts)
                AIChannels.CreateVoltageChannel("Dev3/ai2", "Laser3", AITerminalConfiguration.Rse, 0, 5, AIVoltageUnits.Volts)
                AIChannels.CreateVoltageChannel("Dev3/ai3", "Laser4", AITerminalConfiguration.Rse, 0, 5, AIVoltageUnits.Volts)
